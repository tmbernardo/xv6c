...
extern int sys_cprocdump(void);
extern int sys_vcmake(void);
extern int sys_umem(void);
extern int sys_tmem(void);
extern int sys_getticks(void);
extern int sys_cinfo(void);
extern int sys_udisk(void);
extern int sys_tdisk(void);
...
[SYS_close]   sys_close,
[SYS_cmake]   sys_cmake,
[SYS_climits]   sys_climits,
[SYS_ccons]   sys_ccons,
[SYS_cfork]   sys_cfork,
[SYS_cprocdump] sys_cprocdump,
[SYS_vcmake]   sys_vcmake,
[SYS_umem]   sys_umem,
[SYS_tmem]   sys_tmem,
